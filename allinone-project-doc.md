# AllInOne - Documentation Complète du Projet

## 📋 Vue d'ensemble

**AllInOne** est un moteur de rendu graphique extensible et multi-backend développé en C++. Le projet permet de créer des applications graphiques avec un système de plugins, supportant plusieurs backends de rendu (SDL, OpenGL, MinilibX, Vulkan).
...
Le système de plugins permet d'étendre AllInOne sans modifier le core.
...
AllInOne peut être utilisé comme base pour plusieurs projets 42 :
